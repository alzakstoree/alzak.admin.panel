// ==================== admin.js (نسخة نهائية بدون مصادقة) ====================
...
async function loadDashboard() {
  ...
  return `
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px;">
      <div class="stat-card"><h3>إجمالي المنتجات</h3><p>${totalProducts}</p></div>
      <div class="stat-card"><h3>إجمالي المستخدمين</h3><p>${totalUsers}</p></div>
